...
import com.juntai.wisdom.dgjxb.home_page.call_to_police.VerifiedAdapter;
                ...
                MultipartBody.Builder builder = new MultipartBody.Builder()
                        ...
                        .addFormDataPart("IDCardinHand", "IDCardinHand",
                                RequestBody.create(MediaType.parse("file"),
                                        handIvsfile));
                if (UserInfoManager.getAccountStatus() != 1) {
                    builder.addFormDataPart("code", getTextViewValue(mCheckCodeEt))
                            .addFormDataPart("phoneNumber", getTextViewValue(mPhoneEt));
                }
                requestBody = builder.build();
                mPresenter.userAuth(RegistContract.USER_AUTH, requestBody);
                break;
