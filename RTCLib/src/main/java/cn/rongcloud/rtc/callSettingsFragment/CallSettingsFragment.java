...
public class CallSettingsFragment extends android.app.DialogFragment implements RadioGroup.OnCheckedChangeListener, CallSettingsPagerView.CallSettingsPagerListener {
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        if (radioGroup.getCheckedRadioButtonId() == R.id.rb_call_settings_tab_video){
            pvCallSettingsPager.showVideoPager();
        }else if (radioGroup.getCheckedRadioButtonId() == R.id.rb_call_settings_tab_audio){
        ...
        }else if (radioGroup.getCheckedRadioButtonId() == R.id.rb_call_settings_tab_other){
