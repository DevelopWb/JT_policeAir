...
public class AppRTCAudioManager {
   ...
   * support.
   */
  // (henrika): add support for BLUETOOTH as well.
  ...
  // (henrika): it is possible that EARPIECE should be preferred in some
...
//            onProximitySensorChangedState();
  ...
  public void init() {
    ...
    // (henrika): we migh want to start with RINGTONE mode here instead.
