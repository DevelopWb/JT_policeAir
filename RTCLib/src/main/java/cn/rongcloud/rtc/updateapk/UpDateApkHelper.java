...
public class UpDateApkHelper {
    ...
    private void showUpdateDialog(String targetVersion, final String downLoadUrl) {
        ...
        dlg.setButton(DialogInterface.BUTTON_POSITIVE, activity.getString(R.string.rtc_dialog_ok), new DialogInterface.OnClickListener() {
            @Override
        ...
        dlg.setButton(DialogInterface.BUTTON_NEGATIVE, activity.getString(R.string.rtc_dialog_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dlg.cancel();
            }
